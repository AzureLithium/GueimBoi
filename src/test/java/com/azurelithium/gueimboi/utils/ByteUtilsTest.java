...
public class ByteUtilsTest {
    ...
    public void testSetBit() {
        assertEquals(ByteUtils.setBit(allZeroByte, 0), 0b00000001);
        assertEquals(ByteUtils.setBit(allZeroByte, 1), 0b00000010);
        assertEquals(ByteUtils.setBit(allZeroByte, 2), 0b00000100);
        assertEquals(ByteUtils.setBit(allZeroByte, 3), 0b00001000);
        assertEquals(ByteUtils.setBit(allZeroByte, 4), 0b00010000);
        assertEquals(ByteUtils.setBit(allZeroByte, 5), 0b00100000);
        assertEquals(ByteUtils.setBit(allZeroByte, 6), 0b01000000);
        assertEquals(ByteUtils.setBit(allZeroByte, 7), 0b10000000);
        assertEquals(ByteUtils.setBit(allZeroWord, 0), 0b0000000000000001);
        assertEquals(ByteUtils.setBit(allZeroWord, 1), 0b0000000000000010);
        assertEquals(ByteUtils.setBit(allZeroWord, 2), 0b0000000000000100);
        assertEquals(ByteUtils.setBit(allZeroWord, 3), 0b0000000000001000);
        assertEquals(ByteUtils.setBit(allZeroWord, 4), 0b0000000000010000);
        assertEquals(ByteUtils.setBit(allZeroWord, 5), 0b0000000000100000);
        assertEquals(ByteUtils.setBit(allZeroWord, 6), 0b0000000001000000);
        assertEquals(ByteUtils.setBit(allZeroWord, 7), 0b0000000010000000);
        assertEquals(ByteUtils.setBit(allZeroWord, 8), 0b0000000100000000);
        assertEquals(ByteUtils.setBit(allZeroWord, 9), 0b0000001000000000);
        assertEquals(ByteUtils.setBit(allZeroWord, 10), 0b0000010000000000);
        assertEquals(ByteUtils.setBit(allZeroWord, 11), 0b0000100000000000);
        assertEquals(ByteUtils.setBit(allZeroWord, 12), 0b0001000000000000);
        assertEquals(ByteUtils.setBit(allZeroWord, 13), 0b0010000000000000);
        assertEquals(ByteUtils.setBit(allZeroWord, 14), 0b0100000000000000);
        assertEquals(ByteUtils.setBit(allZeroWord, 15), 0b1000000000000000);
    }

    @Test
    public void testUnsetBit() {
        assertEquals(ByteUtils.unsetBit(allOneByte, 0), 0b11111110);
        assertEquals(ByteUtils.unsetBit(allOneByte, 1), 0b11111101);
        assertEquals(ByteUtils.unsetBit(allOneByte, 2), 0b11111011);
        assertEquals(ByteUtils.unsetBit(allOneByte, 3), 0b11110111);
        assertEquals(ByteUtils.unsetBit(allOneByte, 4), 0b11101111);
        assertEquals(ByteUtils.unsetBit(allOneByte, 5), 0b11011111);
        assertEquals(ByteUtils.unsetBit(allOneByte, 6), 0b10111111);
        assertEquals(ByteUtils.unsetBit(allOneByte, 7), 0b01111111);
        assertEquals(ByteUtils.unsetBit(allOneWord, 0), 0b1111111111111110);
        assertEquals(ByteUtils.unsetBit(allOneWord, 1), 0b1111111111111101);
        assertEquals(ByteUtils.unsetBit(allOneWord, 2), 0b1111111111111011);
        assertEquals(ByteUtils.unsetBit(allOneWord, 3), 0b1111111111110111);
        assertEquals(ByteUtils.unsetBit(allOneWord, 4), 0b1111111111101111);
        assertEquals(ByteUtils.unsetBit(allOneWord, 5), 0b1111111111011111);
        assertEquals(ByteUtils.unsetBit(allOneWord, 6), 0b1111111110111111);
        assertEquals(ByteUtils.unsetBit(allOneWord, 7), 0b1111111101111111);
        assertEquals(ByteUtils.unsetBit(allOneWord, 8), 0b1111111011111111);
        assertEquals(ByteUtils.unsetBit(allOneWord, 9), 0b1111110111111111);
        assertEquals(ByteUtils.unsetBit(allOneWord, 10), 0b1111101111111111);
        assertEquals(ByteUtils.unsetBit(allOneWord, 11), 0b1111011111111111);
        assertEquals(ByteUtils.unsetBit(allOneWord, 12), 0b1110111111111111);
        assertEquals(ByteUtils.unsetBit(allOneWord, 13), 0b1101111111111111);
        assertEquals(ByteUtils.unsetBit(allOneWord, 14), 0b1011111111111111);
        assertEquals(ByteUtils.unsetBit(allOneWord, 15), 0b0111111111111111);
    }
